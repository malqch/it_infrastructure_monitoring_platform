...
<!--                            @click="handleCreate">创建分布式交换机</el-button>-->
<!--                </div>-->
<!--            </el-row>-->
...
<!--                <el-table-column type="selection" align="center"></el-table-column>-->
                ...
                <el-table-column prop="type" :formatter="typeFormat" label="交换机类型" align="center"></el-table-column>
                <el-table-column prop="portGroupNum" label="端口组个数" align="center"></el-table-column>
<!--                <el-table-column prop="isIgmpSnooping" label="支持大帧" align="center"></el-table-column>-->
                <el-table-column prop="isIgmpSnooping" :formatter="igmpFormat" label="IGMP Snooping" align="center"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 格式化igmp
            igmpFormat(row) {
                if (row.isIgmpSnooping === false) {
                    return '未开启';
                }else if(row.isIgmpSnooping === true){
                    return '已开启';
                }
            },
            // 获取华为云环境数据
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$http.get('automation/api/huawei/network/', {
                    headers:{
                        'token': this.token,
                        'env': sessionStorage.getItem('huaweiyun_env')
                    }
                }).then((res)=>{
                    this.tableData = res.data.dvSwitchs;
