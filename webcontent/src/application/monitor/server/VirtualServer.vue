        ...
        <div class="wrapper">
            ...
            <div class="container">
                <el-form :inline="true" v-model="searchData">
                    <el-row>
                        <el-form-item>
                            <el-input v-model="searchData.virtual_ip" clearable placeholder="ip" class="handle-input"></el-input>
                        </el-form-item>
                        <!--                    <el-form-item>-->
                        <!--                        <el-input v-model="searchData.hostname" placeholder="名称" class="handle-input"></el-input>-->
                        <!--                    </el-form-item>-->
                        <el-form-item>
                            <el-input v-model="searchData.hostname" clearable placeholder="主机名" class="handle-input"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-input v-model="searchData.status" clearable placeholder="状态" class="handle-input"></el-input>
                        </el-form-item>
                        <el-form-item>
                ...
                <el-table
                        ...
                        border
                        style="width: 100%">
                    <el-table-column prop="virtual_ip" label="ip" align="center"></el-table-column>
                    <el-table-column prop="hostname" label="名称" align="center"></el-table-column>
        ...
        methods: {
            getData() {
                this.$http.get(`asset/api/virtual_server/?current_page=${this.query.pageIndex}&pre_page=${
                    this.query.pageSize}&virtual_ip=${this.searchData.virtual_ip}&status=${this.searchData.status}&device_vendor=${
                    this.searchData.device_vendor}&device_type=服务器&maintain_status=${this.searchData.maintain_status}&hostname=${this.searchData.hostname}`, {
                    headers:
                        {
