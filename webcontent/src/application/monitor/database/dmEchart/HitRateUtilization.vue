    ...
    export default {
        ...
        methods:{
            drawliquidFill(id,charts){
                ...
                this.cpuEcharts = this.$echarts.init(myChart);
                this.optionCpu= {
                    title: {//标题
                        text:'命中率',
                        textStyle: {//标题的样式
...
//                            color:'#fff',//字体颜色#f60
                    ...
                    series: [{
                        ...
                        outline: {
                            ...
                            itemStyle:{
                                borderColor:'rgba(134,45,225,0.2)', //边框的颜色
                                borderWidth: 7,  //边框的宽度
                                shadowBlur: 9 , //外部轮廓的阴影范围 一旦设置了内外都有阴影
                                shadowColor: 'rgba(134,45,225,0.1)', //外部轮廓的阴影颜色
                            }
                        },
                        backgroundStyle: {
                            //                        color:'rgba(255,0,0,0.1)',//图表的背景颜色
                            color:'rgba(134,45,225,0.45)',//图表的背景颜色
                            //                        borderWidth: '10',//图表的边框宽度
                            //                        borderColor: '#000',//图表的边框颜色
                            itemStyle: {
                                shadowBlur:100,//设置无用
                                shadowColor: '#862de1',//设置无用f60
                                opacity: 1 //设置无用
                            }
                        },
                        itemStyle: {
                        ...
                        color: ['rgba(134,45,225,0.7)','rgba(134,45,225,0.7)','rgba(134,45,225,0.7)',],//水波的颜色 对应的是data里面值
                        shape: 'circle',//水填充图的形状 circle默认圆形  rect圆角矩形  triangle三角形  diamond菱形  pin水滴状 arrow箭头状  还可以是svg的path
                        center: ['50%','49%'],//图表相对于盒子的位置 第一个是水平的位置 第二个是垂直的值 默认是[50%,50%]是在水平和垂直方向居中 可以设置百分比 也可以设置具体值
                ...
                this.cpuEcharts.setOption(this.optionCpu);
                /*window.addEventListener("resize",function () {
                    _this.cpuEcharts.resize();
                });*/
            }
        },
        beforeDestroy() {
