        ...
        <div style="height:100%;width:100%">
            <div class="bodytable"  :id="id">
                <el-row :span="24" class="list_head">
                    <el-col :span="6">SCHEMA名称</el-col>
                    <el-col :span="6">执行数量</el-col>
                    <el-col :span="4">错误数量</el-col>
                    <el-col :span="7">平均执行时间</el-col>
                </el-row>
                <div class="scroll-content" :style="{top}" id="dataWrapper">
                    <el-row :data=dutyRateData  v-for="(item,index) in this.data" :key="index" class="wrapper_div">
                        <el-col :span="6">{{item.schema_name}}</el-col>
                        <el-col :span="6">{{item.count}}</el-col>
                        <el-col :span="4">{{item.err_count}}</el-col>
                        <el-col :span="7">{{item.avg_microsec}}</el-col>
                    </el-row>
                </div>
            </div>
        </div>
