        ...
        <div style="height:100%;width:100%">
            <div class="bodytable"  :id=id>
                ...
                <div class="scroll-content" :style="{top}" id="dataWrapper">
                    <el-row :data=oracleLogFileData  v-for="(item,index) in this.data" :key="index" class="wrapper_div">
                        <el-col :span="4" :offset="1">{{item.MEMBER}}</el-col>
