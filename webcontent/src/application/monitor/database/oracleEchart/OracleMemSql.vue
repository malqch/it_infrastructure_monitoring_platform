        ...
        <div style="height:100%;width:100%">
            <div class="bodytable"  :id=id>
                <el-row :span="24" class="list_head">
                    ...
                    <el-col :span="2">内存读</el-col>
                </el-row>
                <div class="scroll-content" :style="{top}" id="dataWrapper">
                    <el-row :data=oracleMemSqlData  v-for="(item,index) in this.data" :key="index" class="wrapper_div">
                        ...
                        <el-col :span="2">{{item.BUFFER_GETS}}</el-col>
                    </el-row>
                </div>
