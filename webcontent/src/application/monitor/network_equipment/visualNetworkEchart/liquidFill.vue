<template>
    <div class="box-container">
        <div :id=id ref="data" class="echart-container"></div>
    </div>
</template>
        ...
        methods:{
            drawliquidFill(){
                ...
                this.optionCpu= {
                    ...
                    series: [{
                        type: 'liquidFill',//类型
                        data: this.data.seriesData,//数据是个数组 数组的每一项的值是0-1
                        label:{
                            normal: {
                        ...
                        outline: {
                            ...
                            itemStyle:this.data.outlineItemStyle
                        },
...
//                        color: ['rgba(134,45,225,0.7)','rgba(134,45,225,0.7)','rgba(134,45,225,0.7)',],//水波的颜色 对应的是data里面值
                ...
                myChart.setOption(this.optionCpu);
                setTimeout(function() {
