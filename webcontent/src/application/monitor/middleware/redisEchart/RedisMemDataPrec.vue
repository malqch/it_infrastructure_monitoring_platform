    ...
    export default {
        ...
        methods:{
            drawliquidFill(id,charts){
                ...
                let cpuEcharts =echarts.init(myChart);
                this.optionCpu= {
                    title: {//标题
                        text:'数据占用内存比',
                        textStyle: {//标题的样式
...
//                            color:'#fff',//字体颜色#f60
                    ...
                    series: [{
                        ...
                        center: ['50%','42%'],//图表相对于盒子的位置 第一个是水平的位置 第二个是垂直的值 默认是[50%,50%]是在水平和垂直方向居中 可以设置百分比 也可以设置具体值
                ...
                cpuEcharts.setOption(this.optionCpu);
                setTimeout(function() {
                    window.onresize = ()=> {
                        cpuEcharts.resize();
                    }
