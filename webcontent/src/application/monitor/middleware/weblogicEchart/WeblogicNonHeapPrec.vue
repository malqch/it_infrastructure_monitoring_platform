...
//                            color:'#fff',//字体颜色#f60
                    ...
                    series: [{
                        ...
                        outline: {
                            ...
                            itemStyle:{
                                borderColor:'rgba(138,126,78,0.2)', //边框的颜色
                                borderWidth: 7,  //边框的宽度
                                shadowBlur: 9 , //外部轮廓的阴影范围 一旦设置了内外都有阴影
                                shadowColor: 'rgba(138,126,78,0.1)', //外部轮廓的阴影颜色
                            }
                        },
                        backgroundStyle: {
                            //                        color:'rgba(255,0,0,0.1)',//图表的背景颜色
                            color:'rgba(138,126,78,0.45)',//图表的背景颜色
                            //                        borderWidth: '10',//图表的边框宽度
                            //                        borderColor: '#000',//图表的边框颜色
                            itemStyle: {
                                shadowBlur:100,//设置无用
                                shadowColor: '#cdc470',//设置无用f60
                                opacity: 1 //设置无用
                            }
                        },
                        itemStyle: {
                        ...
                        color: ['rgba(205,196,112,0.7)','rgba(205,196,112,0.7)','rgba(205,196,112,0.7)',],//水波的颜色 对应的是data里面值
