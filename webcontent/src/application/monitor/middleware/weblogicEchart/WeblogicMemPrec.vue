    ...
    export default {
        ...
        methods:{
            drawliquidFill(id,charts){
                ...
                this.memEchart = this.$echarts.init(myChart);
                this.optionCpu= {
                    title: {//标题
                        text:'mem利用率',
                        textStyle: {//标题的样式
...
//                            color:'#fff',//字体颜色#f60
                    ...
                    series: [{
                        ...
                        outline: {
                            ...
                            itemStyle:{
                                borderColor:'rgba(19,178,253,0.09)', //边框的颜色
                                borderWidth: 7,  //边框的宽度
                        ...
                        backgroundStyle: {
                            ...
                            color:'rgba(19,178,253,0.15)',//图表的背景颜色
                            //                        borderWidth: '10',//图表的边框宽度
                            //                        borderColor: '#000',//图表的边框颜色
                            itemStyle: {
                                shadowBlur:100,//设置无用
                                shadowColor: '#13b2fd',//设置无用f60
                                opacity: 1 //设置无用
                            }
                        },
                        itemStyle: {
                        ...
                        color: ['rgba(19,178,253,0.4)','rgba(19,178,253,0.4)','rgba(19,178,253,0.4)',],//水波的颜色 对应的是data里面值
                ...
                this.memEchart.setOption(this.optionCpu);
                setTimeout(function() {
