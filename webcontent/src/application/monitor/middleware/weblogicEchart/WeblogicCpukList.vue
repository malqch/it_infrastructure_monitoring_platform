    ...
    <div class="box-container">
        ...
        <div style="height:100%;width:100%">
            <div class="bodytable" :id=id :data=dutyRateData><!--:style="view"-->
                        ...
                        <el-col :span="6">系统CPU负载</el-col>
                        <el-col :span="6">系统平均负载</el-col>
                        <el-col :span="6">进程CPU负载</el-col>
                        <el-col :span="6">处理器数量</el-col>
                    </el-row>
                    <div class="scroll-content" id="dataWrapper">
                        <el-row :data=dutyRateData  v-for="(item,index) in this.data" :key="index" class="wrapper_div">
                            <el-col :span="6">{{item.SystemCpuLoad}}</el-col>
                            <el-col :span="6">{{item.SystemLoadAverage}}</el-col>
                            <el-col :span="6">{{item.ProcessCpuLoad}}</el-col>
                            <el-col :span="6">{{item.AvailableProcessors}}</el-col>
                        </el-row>
                    </div>
            </div>
        </div>
