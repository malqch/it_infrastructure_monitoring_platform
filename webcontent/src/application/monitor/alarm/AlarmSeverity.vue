        ...
        <div class="wrapper">
            <!-- <div class="crumbs">
                 <el-breadcrumb separator="/">
                     <el-breadcrumb-item>
                         <i class="el-icon-lx-cascades"></i> 告警等级管理
                     </el-breadcrumb-item>
                 </el-breadcrumb>
             </div>-->
            <div class="container">
...
<!--                            <el-form-item>-->
<!--                                <el-input v-model="searchData.grade_name" clearable placeholder="告警等级名称" class="handle-input"></el-input>-->
<!--                            </el-form-item>-->
...
<!--                        </div>-->
                ...
                >
                    ...
                    <el-table-column prop="grade_name" label="告警等级名称" align="center"></el-table-column>
                    <el-table-column prop="grade_level" label="告警等级" align="center"></el-table-column>
            ...
            <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
                <el-form ref="form" :model="edit_form" label-width="100px">
                    <el-form-item label="告警等级名称">
                        <el-input v-model="edit_form.grade_name"></el-input>
                    </el-form-item>
            ...
            <el-dialog title="创建" :visible.sync="createVisible" width="30%">
                <el-form ref="form" :model="form" label-width="100px">
                    ...
                    <el-form-item label="告警等级">
                        <el-input v-model="form.grade_level"></el-input>
                    </el-form-item>
                    <el-form-item label="备注">
...
<script>
    export default {
        ...
        methods: {
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$http.get(`monitor/api/alarm_severity/?current_page=${this.query.pageIndex}&pre_page=${
                    this.query.pageSize}&grade_name=${this.searchData.grade_name}&is_delete=${this.searchData.is_delete}`, {
                    headers: {
            ...
            // 保存创建
            saveCreate() {
                this.$http.post(`monitor/api/alarm_severity/`,
                    { 'grade_name': this.form.grade_name, 'grade_level': this.form.grade_level, 'remark': this.form.remark
                    },
                    {
                        headers: {
                            'token': localStorage.getItem('token')
            ...
            handleDelete(row) {
                ...
                }).then(() => {this.$http.put(`monitor/api/alarm_severity/${row.id}/logic_delete/`,
                    {'is_delete': 1},
                    {
                        headers: {
                            'token': localStorage.getItem('token')
            ...
            // 保存编辑
            saveEdit() {
                this.$http.put(`monitor/api/alarm_severity/${this.id}/`,
                    { 'grade_name': this.edit_form.grade_name, 'remark': this.edit_form.remark },
                    {
                        headers: {
                            'token': localStorage.getItem('token')
                        }
